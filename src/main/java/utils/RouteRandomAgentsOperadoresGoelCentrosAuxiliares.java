...
public class RouteRandomAgentsOperadoresGoelCentrosAuxiliares extends RouteRandomAgentsOperadoresGoel {

	public RouteRandomAgentsOperadoresGoelCentrosAuxiliares(NetworkRandom net, int fxV, int fxH, double[] pontosX,
