...
public class RouteRandomAgentsOperadoresGoelUltimos extends RouteRandomAgentsOperadoresGoel {

	public RouteRandomAgentsOperadoresGoelUltimos(NetworkRandom net, int fxV, int fxH, double[] pontosX,
